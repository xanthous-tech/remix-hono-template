...
function PageHeader({
  ...
  return (
    <section
      className={cn(
        'mx-auto flex max-w-[980px] flex-col items-center gap-2 p-8 md:py-12 md:pb-8 lg:py-24 lg:pb-20',
        className,
      )}
      {...props}
    >
...
function PageHeaderDescription({
  ...
  return (
    <div
      className={cn(
        'max-w-[750px] text-center text-md text-muted-foreground sm:text-lg',
        className,
      )}
      {...props}
    />
